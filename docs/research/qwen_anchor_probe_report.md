...
anchor_contradiction_threshold: `0.35`
...
- Conflict minus stable viability gap: `-0.0260`
...
| instruction_constraints | instruction_constraints_stable | stable | 28 | 3 | 0.6190 | 0.3156 | 3 | 0 |
...
| units | units_stable | stable | 31 | 2 | 0.7559 | 0.1742 | 4 | 0 |
| units | units_conflict | conflict | 46 | 3 | 0.7202 | 0.2685 | 3 | 0 |
...
- Conflict-tagged prompts show lower viability than stable prompts in this run (`-0.0260`), which is also the intended direction.
