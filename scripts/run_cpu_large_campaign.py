...
RUN_MATRIX: list[dict[str, Any]] = [
    {"label": "short_t8", "profile": "short", "max_new_tokens": 8, "group_case_cap": 1},
    {"label": "medium_t8", "profile": "medium", "max_new_tokens": 8, "group_case_cap": 1},
    {"label": "long_t8", "profile": "long", "max_new_tokens": 8, "group_case_cap": 1},
    {"label": "short_t16", "profile": "short", "max_new_tokens": 16, "group_case_cap": 1},
    {"label": "medium_t16", "profile": "medium", "max_new_tokens": 16, "group_case_cap": 1},
    {"label": "long_t16", "profile": "long", "max_new_tokens": 16, "group_case_cap": 1},
]
...
def run_cpu_large_campaign() -> Path:
    ...
    for spec in RUN_MATRIX:
        print(
            f"[CPULargeCampaign] label={spec['label']} "
            f"profile={spec['profile']} tokens={spec['max_new_tokens']}"
        )
        result = remote_worker_run(
            "run_qwen_per_case_diagnostic_v2.py",
            {
                ...
                "group_case_cap": spec["group_case_cap"],
            },
            timeout=300,
        )
